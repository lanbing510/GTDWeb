	...
	var methods = {
		...
		init : function( options )
		{
			...
			var settings = $.extend({				
				...
				'outdent':true,
				'fonts':fonts,
				'styles':false, /*styles lxs*/
				'print':false, /*true lxs*/
				'rm_format':true, 
				'status_bar':true,
				'font_size':false, /*fontsizes lxs*/
				'color':colors,
			...
			var statusBar = $("<div/>", {	id : "statusbar",
	       	...
	       	/*
	       	// Increase the height of th eidtor when needed. lxs
	       	var line_count=0;
	       	editor.keyup(function(event){
	       		...
	       		if(keyCode==13)
	       		{
	       			...
	       			if(line_count>5)
	       			{
	       				var previous_height=parseInt($(".Editor-editor").css("height"));
	       				var current_height=(previous_height+25).toString()+"px";
	       				$(".Editor-editor").css("height",current_height);
	       			}
	       		}
	       	});
			*/
